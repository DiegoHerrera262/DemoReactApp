          ...
          >
            <div className="container--partOne--info">
              ...
              <div className="info--financiera">
                <div className="header--infoFinanciera">
                ...
                <h2 className="title--inputs--products">
            ...
            <div className="partTwo--info">
              <div className="info--visualizacion">
                <div className="header--infoVisualizacion">
                  <h1>Visualizacion</h1>
                </div>
              ...
              <div className="info--almacenamiento">
                <div className="header--infoAlmacenamiento">
                  <h1>Informacion de almacenamiento</h1>
                </div>
            ...
            <button className="buttons--products--create" type="submit">
              CREAR PRODUCTO
            </button>
          </form>
        </div>
